...
for h in lazarte:
    ...
    queries = [
        f"Lazarte {title}",
        f"Hermanos Lazarte {title}",
        f"Hermanos Lazarte {l1[:35]}",
    ]
...
with open('data/youtube_lazarte_detailed.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, indent=2, ensure_ascii=False)
print("Resultados guardados en data/youtube_lazarte_detailed.json")
