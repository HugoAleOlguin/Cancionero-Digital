...
url = "https://www.youtube.com/@Musica.MIV.1975/videos"
...
if m:
    ...
    print(f"Total videos extraídos de @Musica.MIV.1975: {len(items)}")
    ...
    with open('data/musica_miv_videos.json', 'w', encoding='utf-8') as f:
        json.dump(vids, f, indent=2, ensure_ascii=False)
    print(f"Guardados {len(vids)} videos en data/musica_miv_videos.json")
else:
