...
queries = [
    'intitle:"conjunto Luján de Cuyo"',
    'intitle:"conjunto Luján"',
    '"conjunto Luján de Cuyo" Carlos Ramírez',
    '"Luján de Cuyo" alabanzas',
    '"Luján de Cuyo" himnos',
    '"Carlos Ramírez" alabanzas Luján',
]
