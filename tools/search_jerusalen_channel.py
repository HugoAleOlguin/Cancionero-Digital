...
queries = [
    '"Conjunto Jerusalén" alabanza',
    '"Conjunto Jerusalen" cassette',
    '"Conjunto Jerusalén" "Asamblea Cristiana"',
    '"Conjunto Jerusalén" "Alabanzas DIOS ES AMOR"',
    '"Conjunto Jerusalén" Mendoza',
]
