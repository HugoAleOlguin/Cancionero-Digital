...
for h in redencion:
    ...
    queries = [
        f"Trio Redencion {title}",
        f"Trío Redención {title}",
        f"Trio Redencion {l1[:35]}",
    ]
...
with open('data/youtube_redencion_detailed.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, indent=2, ensure_ascii=False)
print("Resultados guardados en data/youtube_redencion_detailed.json")
